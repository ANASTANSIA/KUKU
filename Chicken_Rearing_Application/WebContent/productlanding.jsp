...
<%@ page import="com.chickenapp.database.Product"%>
<%@ page import="com.chickenapp.databaseDao.ProductDao"%>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a class="nav-link" href="#">Manage
							Chicken</a></li>
					<li class="nav-item active"><a class="nav-link" href="#">Product
		...
		<div class="row">
					...
					<c:forEach var="product" items="${listProduct}">
						...
						<div class="card-body">
							...
							<img class="card-img-top" src="http://placehold.it/750x300"
								alt="product image"> <a href="#" class="btn btn-primary">Read
								More &rarr;</a>
						</div>
					</c:forEach>
			...
			<div class="col-md-4">
				...
				<div class="card my-4">
					...
					<div class="card-body">
						<a href="AddProduct.jsp" class="btn btn-secondary"
							value="Add Product"> Add Product </a>
					</div>
				</div>
